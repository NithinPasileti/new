...
dateELE.addEventListener("change", () => {
  ...
  dateELE.style.border = "2px solid rgba(0, 0, 0, 0.5)";
  if (age < 20 || age > 60) {
    dateELE.setCustomValidity("The age is not lies between 20 and 60");
...
function validate(ele) {
  if (ele.validity.typeMismatch) {
    ele.setCustomValidity(" Email not in the correct format");
    ele.reportValidity();
  } else {
